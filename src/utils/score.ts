export function calculateScore(weather: any, air: any): number {
  let score = 100;
  ...
  const pm10 = air.current?.pm10 ?? 0;

  if (pm25 > 50) score -= 30;
  else if (pm25 > 25) score -= 15;
  else if (pm25 > 15) score -= 5;

  if (pm10 > 100) score -= 20;
  else if (pm10 > 50) score -= 10;
